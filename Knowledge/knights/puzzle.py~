...
knowledge3 = And(
    ...
    Implication(BKnight, Or(Implication(AKnave, Not(AKnave)), Implication(AKnight, AKnave))),
    Implication(BKnave, Not( Or( Implication(AKnave, Not(AKnave)), Implication(AKnight, AKnave) )) ),
